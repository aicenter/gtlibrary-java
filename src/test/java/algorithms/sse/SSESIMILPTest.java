...
public class SSESIMILPTest {
    ...
    public void BPGTest() {
        ...
        ShallowestBrokenCplexStackelbergLP bfsEnforcingStackelbergLP = new ShallowestBrokenCplexStackelbergLP(root.getAllPlayers()[0], new BPGGameInfo());
