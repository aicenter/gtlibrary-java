...
//    }
    ...
    private double getUtilityUBForCombo(GameState state, List<Map<Action, Double>> minPlayerBestResponse) {
        return minPlayerBestResponse.stream().mapToDouble(bestResponse -> {
            long start = mxBean.getCurrentThreadCpuTime();
