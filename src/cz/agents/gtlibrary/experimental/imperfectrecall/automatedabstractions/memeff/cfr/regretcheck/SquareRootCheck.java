...
//        if(maxRegret > 1e-4)
//            System.err.println(maxRegret + " vs " + Math.sqrt(regrets.length)/Math.sqrt(algorithm.getIterationForPlayerIdx()) + " now stored for " + algorithm.getCurrentSampleIterations());
