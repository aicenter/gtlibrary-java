...
public class AutomatedAbstractionAlgorithm {

    private final GameState rootState;
    private final Expander<MCTSInformationSet> expander;
    private final GameInfo gameInfo;
    private final Map<ISKey, IRCFRInformationSet> currentAbstractionInformationSets;
    private int iteration = 1;
    private int isKeyCounter = 0;
    ...
    public AutomatedAbstractionAlgorithm(GameState rootState, Expander<MCTSInformationSet> expander, GameInfo info) {
    ...
    private void buildInitialAbstraction() {
        buildInformationSets();
        addData(currentAbstractionInformationSets.values());
    }

    private void buildInformationSets() {
    ...
    private ImperfectRecallISKey createISKey(GameState state) {
