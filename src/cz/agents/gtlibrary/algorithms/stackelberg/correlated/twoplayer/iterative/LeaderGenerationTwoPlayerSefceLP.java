 ...
 */
public class LeaderGenerationTwoPlayerSefceLP extends CompleteTwoPlayerSefceLP {
...
//    protected HashMap<Sequence,HashSet<Sequence>> relevantForFollower;
    ...
    protected final boolean HEURISTIC = true;
...
//        relevantForFollower = new HashMap<>();
    ...
    public LeaderGenerationTwoPlayerSefceLP(Player leader, GameInfo info, boolean greedy, boolean max) {
        super(leader, info);
