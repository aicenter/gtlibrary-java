...
//                    }
    ...
    protected Set<Sequence> getShallowestBrokenStrategyCauses(LPData lpData) {
    ...
    protected Set<Sequence> findShallowestBrokenStrategyCause(Map<InformationSet, Map<Sequence, Double>> strategy) {
