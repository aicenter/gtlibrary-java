...
public class MILPQBuilder extends MILPInitialQ {
	
	private Map<Sequence, Double> explSeqSum;

	public MILPQBuilder(Expander<SequenceInformationSet> expander, GameState rootState, double initialValue, double gameValue, IterationData data) {
