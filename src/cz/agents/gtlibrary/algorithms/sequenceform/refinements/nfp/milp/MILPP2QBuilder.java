...
public class MILPP2QBuilder extends MILPInitialP2Q {

	private Map<Sequence, Double> explSeqSum;

	public MILPP2QBuilder(Expander<SequenceInformationSet> expander, GameState rootState, double initialValue, double gameValue, IterationData data) {
