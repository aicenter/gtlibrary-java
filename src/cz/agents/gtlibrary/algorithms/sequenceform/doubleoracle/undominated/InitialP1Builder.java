...
public class InitialP1Builder {
    ...
    public InitialP1Builder(Player[] players) {
        this.players = players;
        lpFileName = "UndominatedP11.lp";
        initTable();
    }
...
//            }
            ...
            //			}
            return new BuilderResult(lpData.getSolver().getObjValue(), createFirstPlayerStrategy(lpData.getSolver(), lpData.getWatchedPrimalVariables()), time);
