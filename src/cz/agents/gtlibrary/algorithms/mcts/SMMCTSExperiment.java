...
public class SMMCTSExperiment {
        private static final int MCTS_ITERATIONS_PER_CALL = 100;
...
//                fm.saveObject(strategy0, "testStrategy.strat");
//                Strategy s = fm.loadObject("testStrategy.strat");
//                assert strategy0.equals(s);
//                UtilityCalculator uc = new UtilityCalculator(rootState, expander);
//                System.out.println("Utilitu calc1: " + uc.computeUtility(s, strategy1));
//                System.out.println("Utilitu calc2: " + uc.computeUtility(strategy0, strategy1));
