...
//	}
    ...
    public double[] evaluate() {
        ...
        double weight = 4 * Math.sqrt(graph.getGraph().edgeSet().size() / 8. + 2);//approximate length of diagonal under assumption that we move on square grid where all 4-neighbouring nodes are connected
