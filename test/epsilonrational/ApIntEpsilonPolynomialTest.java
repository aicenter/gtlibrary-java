...
import cz.agents.gtlibrary.algorithms.sequenceform.gensum.parammilp.numbers.factory.ApIntRationalFactory;
import cz.agents.gtlibrary.algorithms.sequenceform.gensum.parammilp.numbers.factory.EpsilonPolynomialFactory;
import org.junit.Test;

import static org.junit.Assert.assertEquals;

public class ApIntEpsilonPolynomialTest {

    @Test
    public void oneTest() {
        EpsilonPolynomialFactory factory = new EpsilonPolynomialFactory(new ApIntRationalFactory());
    ...
    public void addLongTest() {
        EpsilonPolynomial rational1 = new EpsilonPolynomial(new int[]{1, 2, 3}, new int[]{3, 2, 1}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
        EpsilonPolynomial rational2 = new EpsilonPolynomial(new int[]{4, 5, 6}, new int[]{7, 8, 9}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
    ...
    public void addDifferentLengthsTest() {
        EpsilonPolynomial rational1 = new EpsilonPolynomial(new int[]{1, 2, 3}, new int[]{3, 2, 1}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
        EpsilonPolynomial rational2 = new EpsilonPolynomial(new int[]{4, 5}, new int[]{7, 8}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
    ...
    public void addDifferentLengths1Test() {
        EpsilonPolynomial rational1 = new EpsilonPolynomial(new int[]{1, 2}, new int[]{3, 2}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
        EpsilonPolynomial rational2 = new EpsilonPolynomial(new int[]{4, 5, 6}, new int[]{7, 8, 9}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
    ...
    public void negateTest() {
        EpsilonPolynomial rational = new EpsilonPolynomial(new int[]{1, 2, -3}, new int[]{3, 2, 1}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
    ...
    public void multiplyTest() {
        EpsilonPolynomial rational1 = new EpsilonPolynomial(new int[]{-1, 2, -3}, new int[]{3, 2, 1}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
        EpsilonPolynomial rational2 = new EpsilonPolynomial(1, 3, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
    ...
    public void isZeroSimpleTest() {
        assertEquals(true, new EpsilonPolynomialFactory(new ApIntRationalFactory()).zero().isZero());
    }
    ...
    public void isZeroSimpleTest3() {
        assertEquals(false, new EpsilonPolynomialFactory(new ApIntRationalFactory()).one().isZero());
    }
    ...
    public void isOneSimpleTest() {
        assertEquals(true, new EpsilonPolynomialFactory(new ApIntRationalFactory()).one().isOne());
    }
    ...
    public void isOneSimpleTest3() {
        assertEquals(false, new EpsilonPolynomialFactory(new ApIntRationalFactory()).zero().isOne());
    }
    ...
    public void  compareToLongTest() {
        EpsilonPolynomial polynomial1 = new EpsilonPolynomial(new int[]{2, 3, 4}, new int[]{6, 7, 8}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
        EpsilonPolynomial polynomial2 = new EpsilonPolynomial(new int[]{1, 3, 1}, new int[]{3, 7, 2}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
    ...
    public void  compareToLongTest1() {
        EpsilonPolynomial polynomial1 = new EpsilonPolynomial(new int[]{2, 4, 4}, new int[]{6, 7, 8}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
        EpsilonPolynomial polynomial2 = new EpsilonPolynomial(new int[]{1, 3, 1}, new int[]{3, 7, 2}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
    ...
    public void  compareToLongTest2() {
        EpsilonPolynomial polynomial1 = new EpsilonPolynomial(new int[]{2, 3, 4}, new int[]{6, 7, 9}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
        EpsilonPolynomial polynomial2 = new EpsilonPolynomial(new int[]{1, 3, 1}, new int[]{3, 7, 2}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
    ...
    public void  compareToDifferentLengthsTest() {
        EpsilonPolynomial polynomial1 = new EpsilonPolynomial(new int[]{2, 3}, new int[]{6, 7}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
        EpsilonPolynomial polynomial2 = new EpsilonPolynomial(new int[]{1, 3, 1}, new int[]{3, 7, 2}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
    ...
    public void  compareToDifferentLengthsTest2() {
        EpsilonPolynomial polynomial1 = new EpsilonPolynomial(new int[]{2, 2}, new int[]{6, 7}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
        EpsilonPolynomial polynomial2 = new EpsilonPolynomial(new int[]{1, 3, -1}, new int[]{3, 7, 2}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
    ...
    public void  compareToDifferentLengthsTest3() {
        EpsilonPolynomial polynomial1 = new EpsilonPolynomial(new int[]{2, 3}, new int[]{6, 7}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
        EpsilonPolynomial polynomial2 = new EpsilonPolynomial(new int[]{1, 3, 0}, new int[]{3, 7, 2}, new EpsilonPolynomialFactory(new ApIntRationalFactory()));
