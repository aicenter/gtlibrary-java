...
import cz.agents.gtlibrary.algorithms.stackelberg.iterativelp.CompleteBrokenCplexStackelbergLP;
...
public class SSEAIMILPTest {
    ...
    public void BPGTest() {
        ...
        CompleteBrokenCplexStackelbergLP bfsEnforcingStackelbergLP = new CompleteBrokenCplexStackelbergLP(root.getAllPlayers()[0], new BPGGameInfo());
